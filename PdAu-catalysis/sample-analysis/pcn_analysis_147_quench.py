...
file_names = ['Pd30Au70_147_cuboct_730-300K_rampdown_mlmd_1.all.bin', 
              "Pd24Au76_147_cuboct_720-300K_rampdown_mlmd_1.all.bin",
              "Pd20Au80_147_cuboct_710-300K_rampdown_mlmd_1.all.bin",
              "Pd14Au86_147_cuboct_700-300K_rampdown_mlmd_1.all.bin",
              "Pd10Au90_147_cuboct_690-300K_rampdown_mlmd_1.all.bin",
              "Pd04Au96_147_cuboct_670-300K_rampdown_mlmd_1.all.bin"]
...
for file_name in file_names:
    ...
    csv_file_name = file_name.split('_mlmd')[0] + '.csv' 
    with open(csv_file_name, mode='w', newline='') as file:
        writer = csv.writer(file)
        writer.writerow(['avg_Au_Au', 'avg_Pd_Pd', 'avg_Au_Pd', 'avg_Pd_Au']) # Header
        writer.writerows(csv_data) # All other data
...
# Saving data
average_pCN = "147_pCN_averages_quench.csv"
